...
from ImageSimilarityIndex import ImageSimilarityIndex
    ...
    def process_queries(self, queries_folder, output_folder='Data/Results', k=10):
        ...
        for query_img_path in tqdm(query_images, desc="Processing queries"):
            ...
            if descriptor_type == 'hog':
                ...
                features = self.descriptor_orchestrator.descriptor.compute_hog(gray)
                ...
                features = self.descriptor_orchestrator.descriptor.compute_histogram(image)
            elif descriptor_type == 'mixture':
                features = self.descriptor_orchestrator.descriptor.extract(image)
...
if __name__ == "__main__":
    from Descriptor_orquestror import DescriptorOrchestrator
    
    descriptor = DescriptorOrchestrator(descriptor_type='mixture')
